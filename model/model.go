...
func InitTables(db *gorm.DB) {
	db.AutoMigrate(&ERC721SwapPair{})
	db.AutoMigrate(&ERC721SwapFillTx{})
	db.AutoMigrate(&ERC721Swap{})
	db.AutoMigrate(&ERC721SwapStartTxLog{})
	db.AutoMigrate(&BlockLog{})
	db.AutoMigrate(&ERC721SwapPairCreateTx{})
	db.AutoMigrate(&ERC721SwapPairRegisterTxLog{})
	db.AutoMigrate(&ERC721SwapPairStateMachine{})
	db.AutoMigrate(&ERC721RetrySwap{})
	db.AutoMigrate(&ERC721RetrySwapTx{})
}
